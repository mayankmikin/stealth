...
<script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?key=<spring:message code="GOOGLE_KEY" />&sensor=false"></script>
<script type="text/javascript" src="<c:url value="/static/script/RouteBoxer.js" />"></script>
</head>
